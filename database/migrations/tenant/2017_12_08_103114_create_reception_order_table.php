...
return new class extends Migration {
    ...
    {
        Schema::create('reception_order', function (Blueprint $table) {
            $table->uuid('id')->primary('id');
            $table->uuid('reception_id')->comment('接待(现场咨询)id');
            ...
            $table->tinyInteger('editable')->nullable()->comment('允许改价(套餐用的)');
    ...
    {
        Schema::dropIfExists('reception_order');
    }
};
