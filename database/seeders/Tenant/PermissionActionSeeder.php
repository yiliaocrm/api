...
class PermissionActionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            [
                'permission' => 'report.cashier.list.export',
                'controller' => 'App\Http\Controllers\Web\ExportController',
                'action'     => 'cashierList',
            ],
            [
            ...
            [
                ...
                'controller' => 'App\Http\Controllers\Web\ReportCashierController',
                'action'     => 'depositReceivedDetail',
            ],
            [
                'permission' => 'report.cashier.deposit.detail.export',
                'controller' => 'App\Http\Controllers\Web\ExportController',
                'action'     => 'customerDepositDetail',
            ],
            [
            ...
            [
                ...
                'controller' => 'App\Http\Controllers\Web\ReportConsultantController',
                'action'     => 'order',
            ],
            [
                'permission' => 'report.consultant.order.export',
                'controller' => 'App\Http\Controllers\Web\ExportController',
                'action'     => 'consultantOrder',
            ],
            [
