...
class SceneFieldTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $fields = array_merge(
            ...
            $this->getWorkbenchTodayConfig(),
            $this->getWorkbenchReceptionConfig(),
            $this->getWorkbenchFollowupConfig(),
            ...
            $this->getCashierPayIndexConfig(),
            $this->getCashierDetailIndexConfig(),
            $this->getTreatmentRecordConfig(),
        );
     ...
     * @return array
     */
    private function getWorkbenchFollowupConfig(): array
    {
        return [
            [
    ...
    private function getWorkbenchReceptionConfig(): array
    {
        return [
            [
    ...
    private function getCashierPayIndexConfig(): array
    {
        return [
            [
    ...
    private function getCashierDetailIndexConfig(): array
    {
        return [
            [
    ...
    private function getWorkbenchTodayConfig(): array
    {
        return [
            [
                'page'             => 'WorkbenchToday',
    ...
    private function getTreatmentRecordConfig(): array
    {
        return [
            [
    ...
    private function getReportTreatmentDetail(): array
    {
        return [
            [
