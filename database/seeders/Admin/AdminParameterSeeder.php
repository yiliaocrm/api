...
class AdminParameterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $parameters = [
            ...
            [
                'name' => 'dist_sync_enabled',
                'value' => 'false',
                'type' => 'boolean',
                'remark' => '是否启用dist目录同步',
            ],
            [
                'name' => 'dist_sync_s3_access_key_id',
                'value' => '',
                'type' => 'string',
                'remark' => '静态资源S3访问密钥ID',
            ],
            [
                'name' => 'dist_sync_s3_secret_access_key',
                'value' => '',
                'type' => 'string',
                'remark' => '静态资源S3秘密访问密钥',
            ],
            [
                'name' => 'dist_sync_s3_region',
                'value' => '',
                'type' => 'string',
                'remark' => '静态资源S3区域',
            ],
            [
                'name' => 'dist_sync_s3_bucket',
                'value' => '',
                'type' => 'string',
                'remark' => '静态资源S3存储桶名称(需公网可读)',
            ],
            [
                'name' => 'dist_sync_s3_endpoint',
                'value' => '',
                'type' => 'string',
                'remark' => '静态资源S3端点(可选)',
            ],
            [
                'name' => 'dist_sync_s3_url',
                'value' => '',
                'type' => 'string',
                'remark' => '静态资源公网访问URL(用于拼接dist_path)',
            ],
            [
                'name' => 'dist_sync_s3_use_path_style_endpoint',
                'value' => 'false',
                'type' => 'boolean',
                'remark' => '静态资源S3是否使用路径样式端点',
            ],
            [
                'name' => 'reverb_app_id',
