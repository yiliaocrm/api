...
class ErkaiFillTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $this->assertApplicationRouteExists('erkai/fill', 'GET', ErkaiController::class.'@fill');
        $this->createTables();
    }
    ...
    {
        $request = Request::create('/erkai/fill', 'GET', $query, [], [], [
