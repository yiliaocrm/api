...
class WorkflowRequestSnapshotTest extends TestCase
{
    ...
    public function test_create_version_snapshot_serializes_enum_values_without_string_cast_error(): void
    {
        $workflow = Workflow::query()->create([
            'name' => 'Snapshot Enum Workflow',
            'description' => 'enum snapshot regression test',
            'category_id' => 1,
            'create_user_id' => 1,
            'active' => false,
            'all_customer' => false,
    ...
    public function test_create_version_snapshot_accepts_restore_source(): void
    {
        $workflow = Workflow::query()->create([
            'name' => 'Snapshot Restore Source Workflow',
            'description' => 'restore snapshot source test',
            'category_id' => 1,
            'create_user_id' => 1,
            'active' => false,
            'all_customer' => false,
        ...
        $this->assertNotNull($version);
        $this->assertSame('restore', $version->source);
    }
