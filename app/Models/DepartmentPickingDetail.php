...
class DepartmentPickingDetail extends BaseModel
{
    use QueryConditionsTrait;

    protected $table = 'department_picking_detail';
     ...
     * @return BelongsTo
     */
    public function departmentPicking(): BelongsTo
    {
        return $this->belongsTo(DepartmentPicking::class, 'department_picking_id', 'id');
    }
}
