...
class CustomerRequest extends FormRequest
{
    ...
    private function getCreateRules(): array
    {
        return [
            ...
            'phones.*.relation_id' => 'required|integer|exists:customer_phone_relationships,id',
    ...
    private function getUpdateRules(): array
    {
        ...
        if (user()->hasAnyAccess(['superuser', 'customer.update.phone'])) {
            ...
            $rules['phones.*.relation_id'] = 'required|integer|exists:customer_phone_relationships,id';
        }
