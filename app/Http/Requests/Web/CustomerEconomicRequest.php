...
class CustomerEconomicRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|unique:customer_economic'
        ];
    }
    ...
    {
        return [
            'id' => 'required|exists:customer_economic'
        ];
    }
    ...
    private function getUpdateRules(): array
    {
        return [
            ...
            'name' => [
                'required',
                Rule::unique('customer_economic')->ignore($this->input('id')),
            ]
        ];
    }
    ...
    private function getRemoveRules(): array
    {
        return [
            'id' => [
                'required',
                'exists:customer_economic',
                function ($attribute, $value, $fail) {
                    if (Customer::query()->where('economic_id', $value)->first()) {
