...
class DrugRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return match (request()->route()->getActionMethod()) {
            ...
            'inventory',
            'inventoryBatch',
            'inventoryDetail' => $this->getInfoRules(),
            default => []
        };
    }
    ...
    public function messages(): array
    {
        return match (request()->route()->getActionMethod()) {
            ...
            'inventory',
            'inventoryBatch',
            'inventoryDetail' => $this->getInfoMessages(),
            default => []
        };
    }
    ...
    private function getCreateRules(): array
    {
        return [
            ...
            'goods.approval_number'     => 'nullable|string|max:255',
    ...
    private function getUpdateRules(): array
    {
        return [
            ...
            'goods.approval_number'     => 'nullable|string|max:255',
            'units'                     => 'required|array',
            'units.*.unit_id'           => 'required|exists:unit,id',
            'units.*.id'                => [
                'nullable',
                function ($attribute, $id, $fail) {
    ...
    private function getUpdateMessages(): array
    {
        return [
            ...
            'goods.warn_days.required'           => '[过期预警]不能为空!',
            'goods.warn_days.min'                => '[过期预警]不能小于0!',
            'goods.approval_number.max'          => '[批准文号]不能超过:max个字符',
        ];
    }
    ...
    {
        return [
            'goods_id.required' => '请选择药品',
            'goods_id.exists'   => '药品不存在'
        ];
    }
